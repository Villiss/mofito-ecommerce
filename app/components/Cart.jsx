...
const Cart = () => {
  ...
  return (
    <div className="cart-wrapper" ref={cartRef} >
      <div className="cart-container" onMouseLeave={() => setShowCart(false)}>
        <button
        type="button"
        ...
        {cartItems.length < 1 && (
          <div className="empty-cart">
            ...
            <h3>{Strings.cart_your_bag_is_empty}</h3>
            <Link href="/">
              <button
                type="button"
                onClick={() => setShowCart(false)}
        ...
        {cartItems.length >= 1 && (
          <div className="cart-bottom">
            <div className="total">
              <h3>{Strings.cart_subtotal}</h3>
              <h3>{totalPrice} {Strings.eur_sign}</h3>
            </div>
